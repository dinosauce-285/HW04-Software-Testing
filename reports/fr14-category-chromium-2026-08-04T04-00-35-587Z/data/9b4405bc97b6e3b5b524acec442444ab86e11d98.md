...
- Name: fr14-category/add-category.spec.ts >> FR-14 Quản lý danh mục — Thêm danh mục >> TC03 [negative] Không cho thêm danh mục với tên rỗng
- Location: tests/fr14-category/add-category.spec.ts:27:9

# Error details

```
Error: TC03: tên không hợp lệ ("") vẫn bị tạo — bug C01
...
Call log:
  - TC03: tên không hợp lệ ("") vẫn bị tạo — bug C01 with timeout 5000ms
