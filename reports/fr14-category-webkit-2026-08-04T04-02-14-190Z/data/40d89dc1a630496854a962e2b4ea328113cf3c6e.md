...
- Name: fr14-category/add-category.spec.ts >> FR-14 Quản lý danh mục — Thêm danh mục >> TC09 [edge] Payload SQL injection không được phá vỡ dữ liệu
- Location: tests/fr14-category/add-category.spec.ts:27:9

# Error details

```
Error: TC09: tên không hợp lệ ("'; DROP TABLE categories;--") vẫn bị tạo — bug C03
...
Call log:
  - TC09: tên không hợp lệ ("'; DROP TABLE categories;--") vẫn bị tạo — bug C03 with timeout 5000ms
