...
- Name: fr14-category/add-category.spec.ts >> FR-14 Quản lý danh mục — Thêm danh mục >> TC05 [negative] Không cho thêm danh mục trùng tên đã tồn tại
- Location: tests/fr14-category/add-category.spec.ts:27:9

# Error details

```
Error: TC05: tên không hợp lệ ("Laptop") vẫn bị tạo — bug C02
...
Call log:
  - TC05: tên không hợp lệ ("Laptop") vẫn bị tạo — bug C02 with timeout 5000ms
