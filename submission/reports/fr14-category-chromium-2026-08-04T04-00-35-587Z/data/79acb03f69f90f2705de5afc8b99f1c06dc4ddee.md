...
- Name: fr14-category/add-category.spec.ts >> FR-14 Quản lý danh mục — Thêm danh mục >> TC04 [negative] Không cho thêm danh mục chỉ gồm khoảng trắng
- Location: tests/fr14-category/add-category.spec.ts:27:9

# Error details

```
Error: TC04: tên không hợp lệ ("   ") vẫn bị tạo — bug C01
...
Call log:
  - TC04: tên không hợp lệ ("   ") vẫn bị tạo — bug C01 with timeout 5000ms
