...
- Name: fr14-category/add-category.spec.ts >> FR-14 Quản lý danh mục — Thêm danh mục >> TC06 [edge] Không cho thêm tên vượt quá 255 ký tự
- Location: tests/fr14-category/add-category.spec.ts:27:9

# Error details

```
Error: TC06: tên không hợp lệ ("__LONG_500__") vẫn bị tạo — bug C03
...
Call log:
  - TC06: tên không hợp lệ ("__LONG_500__") vẫn bị tạo — bug C03 with timeout 5000ms
