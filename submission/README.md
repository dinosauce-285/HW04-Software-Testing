...
| 6 | 9 HTML report (3 feature x 3 browser) | §6:83 | [x] 9/9 |
...
|   |-- README.md              file này - test summary + self-assessment (§14:156)
|   |-- CHECKLIST.md           đối chiếu từng điều khoản đề + policy -> file (§14:148)
|   |
|   |-- report/
|   |   |-- Main-Report.md         báo cáo chính (§14:149)
|   |   |-- AI-Review-Fix-Log.md   AI sai gì / sửa gì / vì sao trượt (§6:84)
...
|   |
|   |-- tests/                 * script automation (§14:150)
...
|   |-- data/                  * 7 file .csv - cấm hardcode trong spec (§6:82)
|   \-- html-reports/          * 9 HTML report (§14:151)
|       \-- <feature>-<browser>-<ISO-timestamp>/
|
|-- docs/                      đề bài và chính sách môn học (chỉ đọc)
|-- artifacts/                 trang HTML hỗ trợ làm bài - không nộp
|-- .claude/skills/            Agent Skill playwright-feature-suite (§7)
